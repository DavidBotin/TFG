...
# Verificación de reglas redundantes

Verificamos las reglas redundantes
```{r}
reglas_redundantes <- rulesDtrans[is.redundant(x = rulesDtrans, measure = "confidence")]
reglas_redundantes
```

IMPORTANTEEEEEEE
# https://rpubs.com/Joaquin_AR/397172
# https://rpubs.com/Cristina_Gil/Reglas_Asociacion

Gráficoss
# https://rpubs.com/mimd/780760
